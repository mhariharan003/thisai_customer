...
const menuItems = [
  ...
  { name: "Bookings", href: "/Bookings/BookingsHome", icon: <FaClipboardList className="text-2xl" /> },
...
const Sidebar = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-left mr-5 h-[100%] bg-green-300'>
      ...
      >
        ...
        {menuItems.map((item, index) => (
          <a
            key={index}
            href={item.href}
            className={`flex items-center rounded font-['Roboto'] font-medium ${item.active ? 'text-[#ffffff]' : 'text-[#9CA3AF] hover:text-[#718096]'} transition-colors duration-200`}
          >
